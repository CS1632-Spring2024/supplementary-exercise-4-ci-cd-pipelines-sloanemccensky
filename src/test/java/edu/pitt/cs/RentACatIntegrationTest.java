...
public class RentACatIntegrationTest {
	...
	public void testGetCatNullNumCats0() throws Exception {
		// TODO: Fill in
		// test to see that r has no cats
		// invoke getCat(2); -> ASK HOW TO DO THIS, I'M STUCK
		// assertNull(r.getCat(2));
		// assertEquals("Invalid cat ID." + newline, out);
		if( !r.listCats().equals("") ){
			return;
		}
	...
	public void testListCatsNumCats0() {
		// TODO: Fill in
		// do I write in setUp() at beginning of every single one?
		// how do I check that there are no cats?
